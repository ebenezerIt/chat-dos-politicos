...
export class StoryComponent implements OnInit, AfterViewInit {
  stories = [
    {
      ...
      stories: [
        ...
        {
          title:
            'Não existia uma maneira rápida, simples e fácil de encontrar essas respostas...',
          description: '',
        ...
        {
          title:
            'Com uma interface amigável, informa de maneira clara e objetiva o que eles estão fazendo.',
          description: '',
          img: 'assets/images/7.png',
        },
        {
          title:
            'Queremos trazer  mais  informação  e  engajamento  para aquilo  que  dita o rumo  da nossa nação.',
          description: '',
    ...
    },
    {
      ...
      stories: [
        ...
        },
        {
          ...
          title:
            'Estamos desenvolvendo novas funcionalidades constantemente, ' +
  ...
  ngAfterViewInit() {
    this.animation = document.querySelector(
      'div.progress-value'
    ) as HTMLElement;
    this.animationZoom = document.querySelector(
      'div.progress-value'
    ) as HTMLElement;
  }
  ...
  checkPreviousStoryContent = (previousPage): void => {
    if (this.currentContentStoryIndex) {
      this.currentContentStoryIndex--;
      this.selectedStory = this.stories[this.currentContentStoryIndex];
      this.positionSelectedStory = previousPage
        ? 0
        : this.selectedStory.stories.length - 1;
    }
    this.animationZoom = document.querySelector(
      'div.story-mode'
    ) as HTMLElement;
