...
export class PoliticosClient {
  ...
  listParliamentarians(
    ...
    return this.httpClient
      .get<ParliamentarianListResponse>(
        this.listParliamentariansUrl,
        httpOptions
      )
  ...
  getParliamentarianVotesById(
    ...
    const searchParams = new HttpParams()
      ...
      .append(
        'Include',
        'Parliamentarian.LawVotes.Law,Parliamentarian.LawVotes.LawStatus,Parliamentarian.Processes'
      );
    ...
    return this.httpClient
      .get<ParliamentarianSingleResponse>(
        this.listParliamentarianVotesUrl,
        httpOptions
      )
      .pipe(
        map(list => list),
  ...
  getLawList(): Observable<any> {
    ...
    return this.httpClient.get<any>(this.listLawUrl, httpOptions).pipe(
      map(list => list),
      retry(2),
      catchError(this.handleError)
    );
  ...
  getLawVotesById(lawId: number): Observable<any> {
    const searchParams = new HttpParams()
      ...
      .append(
        'Include',
        'Parliamentarian.Ranking,Parliamentarian.State,Parliamentarian.Party,LawStatus'
      )
    ...
    return this.httpClient
      .get<any>(this.lawVoteUrl, httpOptions)
      .pipe(retry(2), catchError(this.handleError));
  }
  ...
  getLawById(lawId: number): Observable<any> {
    ...
    return this.httpClient
      .get<any>(this.listLawUrl, httpOptions)
      .pipe(retry(2), catchError(this.handleError));
  }

  getParliamentarianQuotasById(
    id: number
  ): Observable<ParliamentarianSingleResponse> {
    const searchParams = new HttpParams()
      .append('ParliamentarianId', id)
