...
export class PoliticosMapper {
  toExpenditure(
    parliamentarianSingleResponse: ParliamentarianSingleResponse
  ): Expenditure {
    const parliamentarianRanking =
      parliamentarianSingleResponse.data.parliamentarianRanking;
    const parliamentarian =
      parliamentarianSingleResponse.data.parliamentarianRanking.parliamentarian;
    ...
    expenditure.cotaParlamentarTotal =
      parliamentarianRanking.parliamentarianQuotaMaxYear;
    expenditure.contaParlamentarGastou =
      parliamentarianRanking.parliamentarian.quotaAmountSum;
    expenditure.cotaParlamentarEconomizou =
      expenditure.cotaParlamentarTotal - expenditure.contaParlamentarGastou;
    expenditure.cotaGabineteTotal =
      parliamentarianRanking.parliamentarianStaffMaxYear;
    expenditure.cotaGabineteGastou =
      parliamentarianRanking.parliamentarianStaffAmountUsed;
    expenditure.cotaGabineteEconomizou =
      expenditure.cotaGabineteTotal - expenditure.cotaGabineteGastou;
    expenditure.cotaTotal = parliamentarianRanking.parliamentarianQuotaTotal;
    expenditure.cotaTotalGastou =
      expenditure.contaParlamentarGastou + expenditure.cotaGabineteGastou;
    expenditure.cotaTotalEconomizou =
      Math.round((expenditure.cotaTotal - expenditure.cotaTotalGastou) * 100) /
      100;
    ...
    expenditure.acessoresGastoMedio =
      expenditure.acessoresGastoTotal / expenditure.acessoresQuantidade;
  ...
  shrinkParliamentariansData(
    parliamentarianData: ParliamentarianDataResponse
  ): ParliamentarianDataResponse {
    ...
    shrink.parliamentarian = this.shrinkParliamentarian(
      parliamentarianData.parliamentarian
    );
    return shrink;
  }
  ...
  shrinkParliamentarians(
    parliamentarian: ParliamentarianListResponse
  ): ParliamentarianListResponse {
    ...
    shrink.data = parliamentarian.data.map(it =>
      this.shrinkParliamentariansData(it)
    );
    return shrink;
  }
}
