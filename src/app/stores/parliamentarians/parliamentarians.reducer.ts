...
export const parliamentariansReducer = createReducer(
    ...
    on(setChatListType, (state, { chatListType }) => ({...state, chatListType: chatListType})),
    on(setCurrentLaw, (state, { currentLaw }) => ({...state, currentLaw: currentLaw, chatListType: ChatListType.LAW}) ),
    on(setCurrentConversation, (state, { currentConversation }) => {
        ...
        return ({...state, currentConversation: currentConversation, list: newList, chatListType: ChatListType.VOTE}) }),
)
